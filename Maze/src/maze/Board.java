			...
			for (int y = 0; y < 28; y++) {
				for (int x = 0; x < 28; x++) {
					...
					if (m.getMap(x, y).equals("h")) {
						g.drawImage(m.getWallHorizontal(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("v")) {
						g.drawImage(m.getWallVertical(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("1")) {
						g.drawImage(m.getL1(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("2")) {
						g.drawImage(m.getL2(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("3")) {
						g.drawImage(m.getL3(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("4")) {
						g.drawImage(m.getL4(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("d")) {
						g.drawImage(m.getDot(), x * 32, y * 32, null);
					}
					
					if (m.getMap(x, y).equals("p")) {
						g.drawImage(m.getPowerPellet(), x * 32, y * 32, null);
					}
					
					
					//Muros Laterales, superiores y T
					if (m.getMap(x, y).equals("5")) {
						g.drawImage(m.gethSuperior(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("6")) {
						g.drawImage(m.gethInferior(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("7")) {
						g.drawImage(m.getvIzquierda(), x * 32, y * 32, null);
					}
					if (m.getMap(x, y).equals("8")) {
						g.drawImage(m.getvDerecha(), x * 32, y * 32, null);
					}
